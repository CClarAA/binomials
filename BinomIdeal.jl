...
function extractInclusionMinimalIdeals(A::Array{Any,1})
	...
	while n>0
		if tpyoef(Result[1])!= Singular.sideal{Singular.spoly{Singular.n_unknown{QabElem}}}
...
function makeBinomials(P::PChar, R::Singular.PolyRing)
	#output: ideal generated by the binomials corresponding to the domain P.A of the partial character P
