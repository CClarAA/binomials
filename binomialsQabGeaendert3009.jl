...
function cellularDecomp2(I::Singular.sideal) 
	#with redundancies
	#input: binomial ideal I
	#output: a cellular decomposition of I
...
function cellularDecompMacaulay(I::Singular.sideal) 
	#algorithm after Macaulay2 implementation
	#algorithmus scheint schneller zu sein allerdings gibt es immer noch teilweise beispiele 
	#die ewig brauchen (nicht terminieren?) -- noch nicht so viel getestet
