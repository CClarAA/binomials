...
function makeBinomials(P::PChar, R::Singular.SingularPolyRing)
	...
	for k=1:nr
			...
			#the new generator for theideal is monomial1-P.b[k]*minomial2

			#folgende Zeile reinnehmen wenn das mit Polynomringen klappt
			#I=I+SingularIdeal(R,monomial1-P.b[k]*monomial2)
			I=I+SingularIdeal(R,monomial1-monomial2)
	end	
